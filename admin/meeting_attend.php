                    ...
                    <div class="row"> 
                        ...
                        <section class="sec__02">
                            ...
                            <?php if(isset($_SESSION['mail']) && $_SESSION['type']==3): ?>
                                ...
                                <form action="meeting_attend.php" method="post">
                                <?php
...
// 年月選択前のデフォルトの年月を取得
                            ...
                            while($result=$stmt->fetch(PDO::FETCH_ASSOC)):
                                ...
                                $dD=$result["date"];
                                $attA=$result["attend"];
                                //echo "<dl class='attend__mem'><dt>",$mM," / ",$dD,"</dt><dd>",$attA,"</dd></dl>";
                                $ymd[]+=$yY.$mM.$dD;
                            endwhile;
                            echo "</div>";
                            ...
                            while(1):
                                ...
                                for($j=0;$j<7;$j++):
                                    ...
                                    elseif(in_array($thisymd,$ymd)):
                                        echo "<td class='sche__input have'><form action='meeting_attend_input.php?$year-$month-$thisdate' method='post'><input type='hidden' name='yy' value='$year'><input type='hidden' name='mm' value='$month'><input type='hidden' name='dd' value='$thisdate'><input type='hidden' name='dy' value='$day'><input type='submit' value='$thisdate'></form></td>";

                                    else:
                                        echo "<td class='sche__input'><form action='meeting_attend_input.php?$year-$month-$thisdate' method='post'><input type='hidden' name='yy' value='$year'><input type='hidden' name='mm' value='$month'><input type='hidden' name='dd' value='$thisdate'><input type='hidden' name='dy' value='$day'><input type='submit' value='$thisdate'></form></td>";
